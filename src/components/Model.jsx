...
const Model = () => {
    ...
    return (
        <section className="common-padding">
            ...
            <flex className="flex flex-col items-center mt-5">
                <div className="w-full h-[75vh] md:h-[90vh] overflow-hidden relative">
                    ...
                    >
                        {/*View port is a way to render multiple views of a model in the same canvas. It allow us to animate that model*/}
                        <View.Port/>
                    </Canvas>
                </div>
